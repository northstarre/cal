  ...
  return (
    <div className="mx-auto 2xl:container">
      <div
        ...
        <div className={"font-[Fira Sans] mx-auto max-w-[1200px] text-3xl font-bold md:text-4xl lg:text-5xl"}>
        ...
        <form className={"md:px-68 flex flex-col self-center px-0 font-[Raleway]"}>
          ...
          <div className={"mt-10 flex flex-col items-center text-center font-[Raleway]"}>
            ...
            <input
              type={"email"}
              className={"text-[20] mt-5 h-[36px] min-w-[424px] rounded-[5px] border-[2px] border-[#e0e0e0] "}
              placeholder={"Email"}
            />
            <input
              type={"submit"}
