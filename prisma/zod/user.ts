...
export const _UserModel = z.object({
  ...
  describer: z.string().nullish(),
  willGiveAdvice: z.boolean(),
  willGetAdvice: z.boolean(),
  interest1: z.string().nullish(),
  interest2: z.string().nullish(),
  interest3: z.string().nullish(),
  interest4: z.string().nullish(),
  major: z.string().nullish(),
  preProfessionalTrack: z.string().nullish(),
  ...
  stripeDetailsCollected: z.boolean(),
...
export const UserModel: z.ZodSchema<CompleteUser> = z.lazy(() => _UserModel.extend({
  ...
  credits: CreditModel.array(),
  payouts: PayoutModel.array(),
}))
